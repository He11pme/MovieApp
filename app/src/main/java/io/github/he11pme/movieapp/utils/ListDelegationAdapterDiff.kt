...
/**
 * A RecyclerView adapter that combines the capabilities of [ListDelegationAdapter]
 * from the AdapterDelegates library with automatic list diffing using [AsyncListDiffer].
 *
